...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Visit Date (Required)_vi'), '29/04/2019')

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'J\'aime particulièrement les langoustes aromatisées aux herbes et le bootleg champagne au sida')
